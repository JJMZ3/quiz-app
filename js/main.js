const questions = [
    ...
    {
        question: "When was the Matallica band created?",
        answers: [
    ...
    {
        question: "What is the name of the slipknot vocalist?",
        answers: [
            {text: "Jim Root", correct: false},
            {text: "Eminem", correct: false},
            {text: "Drake", correct: false},
            {text: "Corey Taylor", correct: true},
        ]
    },
    {
    ...
    {
        question: "What is the best-selling book in history?",
        answers: [
            {text: "Harry Potter", correct: false},
            {text: "El principito", correct: false},
            {text: "La Biblia", correct: true},
            {text: "Odisea", correct: false},
        ]
    }
];
